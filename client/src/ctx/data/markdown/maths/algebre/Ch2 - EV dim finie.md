...
Contadiction, cette famille n'engendre pas $\R[X]$ en entier.
...
# 2 - Sous-espaces et dimension

## **Proposition** - Soit $E$ un $\mathbb{K}$-ev de dimension finie.
...
#### __Remarque__ - Résultat analogue
